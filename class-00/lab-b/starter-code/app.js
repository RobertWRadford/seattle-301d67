...
//Apparently the window is, but I don't really understand why to be honest
// 3. Explain why "this" is different when an arrow function is used.
// according to https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions my understanding is that it has no binding to this or super when used as a method of a class
