...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: making line 33 const rather than var made it only assigned within the scope of the while statement so it was undefined at line 38 when it was logged
  console.log(viewed);
